...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.ChangePass_Button.setGeometry(QtCore.QRect(300, 130, 261, 91))
        font = QtGui.QFont()
        ...
        self.ChangeMail_Button.setGeometry(QtCore.QRect(650, 130, 261, 91))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.AddAcount_Button.setGeometry(QtCore.QRect(1000, 130, 261, 91))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.AddAcount_Button.setFont(font)
        self.AddAcount_Button.setObjectName("AddAcount_Button")
        self.tableWidget = QtWidgets.QTableWidget(parent=self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(60, 260, 1481, 471))
        ...
        self.Back_Button.setGeometry(QtCore.QRect(10, 10, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Back_Button.setFont(font)
        self.Back_Button.setObjectName("Back_Button")
        self.label = QtWidgets.QLabel(parent=self.centralwidget)
        self.label.setGeometry(QtCore.QRect(570, 30, 411, 41))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.AddAcount_Button.setText(_translate("MainWindow", "Edit acocunt"))
